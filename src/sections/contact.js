...
export function createContact() {
  ...
  const linkItems = LINKS.map((l, i) => `
    <a href="${l.href}" target="${l.href.startsWith('mailto') ? '_self' : '_blank'}" rel="noopener" 
       class="contact__link reveal reveal-delay-${i + 1}">
      <div class="contact__link-icon" style="color:${l.color}">
        ${l.icon}
      </div>
  ...
  section.innerHTML = `
    <div class="container">
      <div class="contact__inner">
        ...
        <p class="contact__subtitle reveal">
          ¿Tienes un proyecto en mente o necesitas un developer que lleve tu idea a producción?
